...
//  Project14
//
//  Created by Sabrina Fletcher on 4/3/18.
        ...
        if let touch = touches.first{
            ...
            for node in tappedNodes{
                if node.name == "charFriend"{
                    ...
                    //whackSlot.smokeEffect(penguin: node)
                    score -= 5
                    
                    run(SKAction.playSoundFileNamed("whackBad.caf", waitForCompletion: false))
                    //plays bad whack sound when you whack the wrong penguin
                    ...
                    //plays good whack sound when you whack the right penguin
                }
            }
        }
    }
